...
function CounterHook() {
    ...
    // },[count,text])//between [] we put the data we want under useEffect
    ...
    return (
        <div>
            ...
            <button onClick={addArticle} className="btn btn-primary">AddArticle</button>
